        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                ...
                <p class="text-sm text-slate-500 mt-2">
                    You are logged in as an Staff.
                    Use the sidebar to manage borrowings, returns, and reports.
                </p>
            </div>
            ...
            <div class="flex gap-4">
                <a href="{{ route('staff.reports.borrowings') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg">
                    Borrowing Report
                </a>

                <a href="{{ route('staff.reports.returns') }}" class="px-4 py-2 bg-emerald-600 text-white rounded-lg">
                    Return Report
                </a>

                <a href="{{ route('staff.reports.all') }}" class="px-4 py-2 bg-slate-700 text-white rounded-lg">
                    Full Report
                </a>
            </div>
